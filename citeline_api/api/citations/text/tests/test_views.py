...
class TextCitationCollectionViewsIntegrationTestCase(
        testing.views.CollectionViewTestCase):

    layer = testing.layers.MongoIntegrationTestLayer

    # Define resource and view classes
    from ..resources import TextCitationCollection
    from ..views import TextCitationCollectionViews
    RESOURCE_CLASS = TextCitationCollection
    VIEW_CLASS = TextCitationCollectionViews
    ...
    def setUp(self):
        ...
        data.TextCitation.drop_collection()

    def test_create_citation_source_with_source_id_string_reference(self):
        """TextCitationCollectionViews.create() accepts a string-formatted ObjectId as a source
        """
        from citeline import data
...
class TextCitationDocumentViewsIntegrationTestCase(
    ...
    # Define resource and view classes
    from ..resources import TextCitationCollection
    from ..views import TextCitationDocumentViews
    RESOURCE_CLASS = TextCitationCollection
    VIEW_CLASS = TextCitationDocumentViews
